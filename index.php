...
<header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <a href="" class="text-sm/6 font-semibold text-gray-900"> Acceuil </a>
        <a href="" class="text-sm/6 font-semibold text-gray-900"> Nos services </a>
        <a href="" class="text-sm/6 font-semibold text-gray-900"> Contact </a>
        <a href="" class="text-sm/6 font-semibold text-gray-900"> A Propos </a>
      </div>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="login.php" class="text-sm/6 font-semibold text-gray-900"> Connexion <span aria-hidden="true">&rarr;</span></a>
      </div>
    </nav>
      ...
      <div class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        <div class="flex items-center justify-between">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <div class="py-6">
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50"> Connexion </a>
            </div>
          </div>
        </div>
      </div>
